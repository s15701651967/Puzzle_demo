...
import java.util.Random;
    ...
    public class MainActivity_simple extends AppCompatActivity implements View.OnClickListener {
        ...
        void initView()
        {
            ...
            help.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(MainActivity_simple.this, "游戏规则，移动拼图，使拼图按从小到大的顺序摆放，如123 456 78即为成功", Toast.LENGTH_SHORT).show();
